  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
        ...
        <main className="lg:col-span-9 space-y-0">
          <div className="prose dark:prose-invert max-w-none prose-p:text-muted-foreground prose-p:leading-relaxed prose-p:text-lg prose-headings:font-black prose-headings:italic">
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="saas-card !p-8 border-emerald-500/10">
                  <h4 className="text-foreground font-black italic">Personal Info</h4>
                  <p className="text-sm">Name, email address, and institutional affiliation for account management.</p>
                </div>
                <div className="saas-card !p-8 border-emerald-500/10">
                  <h4 className="text-foreground font-black italic">Academic Data</h4>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-muted/30 border border-border rounded-3xl overflow-hidden p-8 space-y-4">
                <p className="text-sm font-bold text-foreground">Razorpay: Encrypted payment processing.</p>
                <p className="text-sm font-bold text-foreground">Google OAuth: Secure authentication provider.</p>
                <p className="text-sm font-bold text-foreground">Adsterra: Anonymous metadata for monetization.</p>
              </div>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="flex flex-wrap gap-4 pt-4">
                {['Right to Erasure', 'Data Portability', 'Right to Rectification'].map((right, i) => (
                  <div key={i} className="px-6 py-3 bg-muted border border-border rounded-full text-xs font-black uppercase tracking-widest text-emerald-500">
                    {right}
                  </div>
                ))}
              </div>
            ...
            <div className="space-y-6">
              ...
              <div className="saas-card !p-8 inline-flex items-center gap-6 group hover:border-emerald-500/50 transition-all">
                ...
                <div>
                  <h4 className="text-sm font-black uppercase tracking-widest text-foreground">Data Protection Office</h4>
      ...
      <button 
        ...
        className="lg:hidden fixed bottom-10 right-10 w-16 h-16 bg-emerald-500 text-white rounded-full shadow-2xl flex items-center justify-center z-50 border-4 border-background active:scale-95 transition-all"
      >
