...
class ReportPDF(FPDF):
    def header(self):
        ...
        self.cell(0, 10, 'ScholarOS', new_x="LMARGIN", new_y="NEXT", align='L')
    ...
    def footer(self):
        ...
        self.cell(0, 10, f'Page {self.page_no()} | Generated on {datetime.now().strftime("%Y-%m-%d %H:%M")} | Powered by ScholarOS', align='C')
...
def generate_pdf(data):
    ...
    pdf.multi_cell(0, 4, "Disclaimer: This report is generated by an AI model based on historical data. Actual results may vary. ScholarOS is not responsible for any admission decisions.")
